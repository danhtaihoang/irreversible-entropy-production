...
!!! 11.06.2015: Bo sung histogram of M (tuc P(M))
!!! 25.06.2015: Sua them epsilon de tinh eps^nu.L
!%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%! 
   PROGRAM main_BIO
   IMPLICIT NONE
   ...
   REAL    (KIND=8),PARAMETER :: nul=0.,aaa=2.5,dimension=3.
   ...
   REAL (KIND=8)    :: eps_min,eps_max,del_eps,eps,Mmin,Mmax,delM,M,M2_av,E2_av,Cv,SiSi_av
   REAL (KIND=8)    :: CL,TS,MS,xi,Jc
...
!!!%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
   ...
   DO i_eps=1,n_eps
      ...
      !!! 25.06.2015: Sua lai epsilon theo: eps^nu.L
      IF (eps/=0.) THEN
      eps=eps/nx
      eps=(abs(eps)**(1./0.63))*eps/abs(eps)
      END IF
...
!!!%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
   ...
   WRITE(line21,*)eps,E_av,M_av,Cv,chi
...
!!!%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
   ...
   DO i=1,natom
   DO j=1,natom
      CL=1.   !!! Chi bo vao de lap khoang trong, can phai xoa khi dung
   ...
   DO i=1,natom
   DO j=1,natom
      MS=1. !!! Chi bo vao de lap khoang trong, can phai xoa khi dung
      !MS=MS+SiSj_av(i,j)      
   END DO
   END DO
   ...
   DO i=1,natom
   DO j=1,natom
      TS=1. !!! Chi bo vao de lap khoang trong, can phai xoa khi dung
