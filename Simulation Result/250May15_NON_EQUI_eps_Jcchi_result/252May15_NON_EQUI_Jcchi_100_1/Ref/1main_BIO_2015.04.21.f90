...
!%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%! 
   ...
   REAL (KIND=8)    :: n_atom,E,E1,E_av,Jmp,rdn_s,rdn_mp
...
!!!%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
   ...
   Cv= n_atom*(E2_av-E_av**2.)*Jmp*Jmp
   Ksi=n_atom*(M2_av-M_av**2.)*Jmp

   WRITE(line21,*)Jmp,E_av,M_av,Cv,Ksi,E2_av,M2_av
   ...
   DO i_histo=1,nM
      ...
      WRITE(line31,*)Jmp,M_histo(i_histo)/n_atom,P_histo(i_histo)
